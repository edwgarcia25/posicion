...
iotfClient.on("connect", function () {
    ...
    setInterval(function(){
        ...
        //
        // increment latitud up to 100 then back down to 0
        //
        //if (dataPacket.d.latitud === 0) {
        //   var countingUp = true;
        //} else if (dataPacket.d.latitud === 100) {
        //   var countingUp = false;
        //}
        //if (countingUp === true) {
        //    if (dataPacket.d.latitud === 100) {
        //       var countingUp = false;
        //    } else1{
        //       var countingUp = true;
        //    }
        //    var latitudIncrement = 20;
        //} else {
        //    if (dataPacket.d.latitud === 0) {
        //       var countingUp = true
        //    } else {
        //       var countingUp = false;
        //    }
            var latitudIncrement = 1.5;
            var longitudIncrement = 2.3;
          //  var luminosityIncrement = 1;
        //}
        //if (dataPacket.d.latitud === 100) {
          //  dataPacket.d.latitud = 0;
        //}
        dataPacket.d.latitud = dataPacket.d.latitud + latitudIncrement;

        //if (dataPacket.d.humidity === 100) {
          //  dataPacket.d.humidity = 0;
        //}
        //dataPacket.d.humidity = dataPacket.d.humidity + longitudIncrement;


        //
        // increment the longitud until 100 and start again at 0
        //
        //var longitudIncrement = 1;
        //if (dataPacket.d.longitud === 100) {
          //  dataPacket.d.longitud = 0;
        //}
        dataPacket.d.longitud = dataPacket.d.longitud + longitudIncrement;
